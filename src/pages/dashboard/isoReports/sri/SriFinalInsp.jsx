  ...
  const onFinish = async (formData) => {
    try {
      ...
      const formattedRejDtls = formattedRejAnls(rejectionAnalysisDtls);
			...
			const cls60 = (formData.railSection === "60E1" || formData.railSection === "60E1A1") ? {...data?.responseData?.masterDtls, ...formattedRejDtls,} : {}
			const cls52 = (formData.railSection !== "60E1" && formData.railSection !== "60E1A1") ? {...data?.responseData?.masterDtls, ...formattedRejDtls,} : {}
	...
	console.log("FORMDATA: ", formData?.cls52?.defect26m?.["NMI"] ?? "")
          ...
          <table className="iso-table w-full">
            ...
            <tbody>
              <tr>
                ...
                <td className="cell-style">5213macpt</td>
                <td className="cell-style">5226macpt</td>
                <td className="cell-style">6013macpt</td>
                <td className="cell-style">6026macpt</td>
             ...
             {/* REFINISH */}
				...
				<div className="overflow-x-auto-iso-table">
					<table className="w-full iso-table">
						<thead>
							<tr>
								<th className="cell-style text-center" colSpan={12}>REJECTION ANALYSIS</th>
							</tr>
							<tr>
								<th className="cell-style text-center" colSpan={6}>52KG</th>
								<th className="cell-style text-center" colSpan={6}>60KG</th>
							</tr>
							...
							<tbody>
								<tr>
									...
									<td className="cell-style"> { formData?.cls52?.defect13m?.["NMI"] ?? ""} </td>
									<td className="cell-style"> { formData?.cls52?.defect26m?.["NMI"] ?? ""}  </td>

									<td className="cell-style">KK</td>
									<td className="cell-style"> {formData?.cls52?.defect13m?.["KK"] ?? ""} </td>
									<td className="cell-style"> {formData?.cls52?.defect26m?.["KK"] ?? ""} </td>

									<td className="cell-style">NMI</td>
									<td className="cell-style"> {formData?.cls60?.defect13m?.["NMI"] ?? ""}  </td>
									<td className="cell-style"> {formData?.cls60?.defect13m?.["NMI"] ?? ""}  </td>

									<td className="cell-style">KK</td>
									<td className="cell-style"> {formData?.cls60?.defect13m?.["KK"] ?? ""} </td>
									<td className="cell-style"> {formData?.cls60?.defect26m?.["KK"] ?? ""} </td>
								</tr>

								<tr>
									<td className="cell-style">MDF</td>
									<td className="cell-style"> {formData?.cls52?.defect13m?.["MDF"] ?? ""} </td>
									<td className="cell-style"> {formData?.cls52?.defect26m?.["MDF"] ?? ""} </td>

									<td className="cell-style">WY</td>
									<td className="cell-style"> {formData?.cls52?.defect13m?.["WY"] ?? ""} </td>
									<td className="cell-style"> {formData?.cls52?.defect26m?.["WY"] ?? ""} </td>

									<td className="cell-style">MDF</td>
									<td className="cell-style"> {formData?.cls60?.defect13m?.["MDF"] ?? ""} </td>
									<td className="cell-style"> {formData?.cls60?.defect26m?.["MDF"] ?? ""} </td>

									<td className="cell-style">WY</td>
									<td className="cell-style"> {formData?.cls60?.defect13m?.["WY"] ?? ""} </td>
									<td className="cell-style"> {formData?.cls60?.defect26m?.["WY"] ?? ""} </td>
								</tr>
{/* 
								<tr>
...
<tr>
  ...
  <td className="cell-style"> {formData?.cls52?.defect13m?.["HH"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["HH"] ?? ""} </td>
  <td className="cell-style">LH</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["LH"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["LH"] ?? ""} </td>
  <td className="cell-style">HH</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["HH"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["HH"] ?? ""} </td>
  <td className="cell-style">LH</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["LH"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["LH"] ?? ""} </td>
</tr>

<tr>
  <td className="cell-style">OHT</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["OHT"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["OHT"] ?? ""} </td>
  <td className="cell-style">UHT</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["UHT"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["UHT"] ?? ""} </td>
  <td className="cell-style">OHT</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["OHT"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["OHT"] ?? ""} </td>
  <td className="cell-style">UHT</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["UHT"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["UHT"] ?? ""} </td>
</tr>

<tr>
  <td className="cell-style">NF</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["NF"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["NF"] ?? ""} </td>
  <td className="cell-style">WF</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["WF"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["WF"] ?? ""} </td>
  <td className="cell-style">NF</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["NF"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["NF"] ?? ""} </td>
  <td className="cell-style">WF</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["WF"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["WF"] ?? ""} </td>
</tr>

<tr>
  <td className="cell-style">TF(+)</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["TF(+)"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["TF(+)"] ?? ""} </td>
  <td className="cell-style">TF(-)</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["TF(-)"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["TF(-)"] ?? ""} </td>
  <td className="cell-style">TF(+)</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["TF(+)"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["TF(+)"] ?? ""} </td>
  <td className="cell-style">TF(-)</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["TF(-)"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["TF(-)"] ?? ""} </td>
</tr>
...
<tr>
  ...
  <td className="cell-style"> {formData?.cls52?.defect13m?.["HF(+)"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["HF(+)"] ?? ""} </td>
  <td className="cell-style">HF(-)</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["HF(-)"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["HF(-)"] ?? ""} </td>
  <td className="cell-style">HF(+)</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["HF(+)"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["HF(+)"] ?? ""} </td>
  <td className="cell-style">HF(-)</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["HF(-)"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["HF(-)"] ?? ""} </td>
</tr>
...
<tr>
  ...
  <td className="cell-style"> {formData?.cls52?.defect13m?.["HS"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["HS"] ?? ""} </td>
  <td className="cell-style">LS</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["LS"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["LS"] ?? ""} </td>
  <td className="cell-style">HS</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["HS"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["HS"] ?? ""} </td>
  <td className="cell-style">LS</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["LS"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["LS"] ?? ""} </td>
</tr>

<tr>
  <td className="cell-style">TNW</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["TNW"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["TNW"] ?? ""} </td>
  <td className="cell-style">TKW</td>
  <td className="cell-style"> {formData?.cls52?.defect13m?.["TKW"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls52?.defect26m?.["TKW"] ?? ""} </td>
  <td className="cell-style">TNW</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["TNW"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["TNW"] ?? ""} </td>
	<td className="cell-style">TKW</td>
  <td className="cell-style"> {formData?.cls60?.defect13m?.["TKW"] ?? ""} </td>
  <td className="cell-style"> {formData?.cls60?.defect26m?.["TKW"] ?? ""} </td>
	</tr>
							</tbody>
