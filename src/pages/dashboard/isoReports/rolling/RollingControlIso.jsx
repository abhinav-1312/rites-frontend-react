...
const mergeHeatDetails = (data, formData) =>  {
  ...
  const onFinish = async (formData) => {
    try{
        const {data} = await apiCall("POST", "/iso/getRollingControlDtls", token, formData)
  ...
  return (
    <div>
      ...
      <div className="a4-container" ref={repRef}>
        <IsoHeader 
            engTitle="FORMAT FOR ROLLING STAGE CONTROL <br /> (Clause No. 8.5 of ISO 9001:2015)"
            hinTitle="रोलिंग चरण नियंत्रण के लिए प्रारूप"
