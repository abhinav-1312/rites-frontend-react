...
const SrNewInspectionForm = () => {
  ...
  // const handleAcceptedTonnageChange = (fieldName, value) => {
  //   let totalTonnageAccepted = 0;
    ...
    <FormContainer>
      ...
      <Form form={form} layout="vertical" initialValues={formData} onFinish={onFinish} >
        <div className="flex gap-2">
          <h2 className="font-bold">Total Tonnes Accepted:</h2>
        </div>
        <div className="flex gap-2">
          <h2 className="font-bold">Total Tonnes Rejected :</h2>
        </div>
        <div className="flex gap-2">
          <h2 className="font-bold">Total Tonnes Inspected :</h2>
        </div>
        <Divider />
        ...
        <div className="relative mb-6">
          ...
          <div className="border grid grid-cols-5 divide-x divide-y divide-gray-300 mt-2">
            ...
            {formData.rejectionAnalysisDtls?.map((record, index) => (
              <>
                <div className="p-2">
                  <FormDropdownItem className="no-border" name={["rejectionAnalysisDtls", index, "rejection26mAnalysisDefect"]} formField="rejection26mAnalysisDefect" dropdownArray={defectList} visibleField="value" valueField="key" onChange={(name, value) => handleRejAnaDtlChange(name, value, index)} showSearch required />
                </div>
                <div className="p-2">
                ...
                <div className="p-2">
                  <FormDropdownItem className="no-border" name={["rejectionAnalysisDtls", index, "rejection13mAnalysisDefect"]} formField="rejection13mAnalysisDefect" dropdownArray={defectList} visibleField="value" valueField="key" onChange={(name, value) => handleRejAnaDtlChange(name, value, index)} showSearch required />
                </div>
                <div className="p-2">
